...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinRobotNumber = QtGui.QSpinBox(self.centralwidget)
        self.spinRobotNumber.setMinimum(0)
        self.spinRobotNumber.setMaximum(10)
        self.spinRobotNumber.setProperty("value", 0)
        self.spinRobotNumber.setObjectName(_fromUtf8("spinRobotNumber"))
        self.verticalLayout_4.addWidget(self.spinRobotNumber)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p>Cover line width<br/>In meters</p></body></html>", None))
